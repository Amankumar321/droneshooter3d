...
export default function FlyControls (object, domElement, nipple, pointer) {
  ...
  if (pointer) {
    ...
    this.pointer.on('attain', movements => {
      ...
      movements.on('data', move => {
        move.dx = move.dx * sensitivity
        move.dy = move.dy * sensitivity
  ...
  this.keydown = function (event) {
    ...
    socket.emit('keydown', {moveVector: this.moveVector, rotationVector: this.rotationVector, position: this.object.position, rotation: this.object.rotation, velocity: this.velocity});
  }
  ...
  this.keyup = function (event) {
    ...
    socket.emit('keyup', {moveVector: this.moveVector, rotationVector: this.rotationVector, position: this.object.position, rotation: this.object.rotation, velocity: this.velocity});
  }
