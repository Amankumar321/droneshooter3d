...
const controlLoop = (timestamp, delta) => {
...
const initControls = (msg, data) => {
  ...
  autoPilot = new AutoPilot(camera, controls.module, false)
  keyboardJS.bind('p', e => autoPilot.toggle())

  PubSub.publishSync('x.loops.unshift', controlLoop)
